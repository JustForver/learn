...
import {fetchPhoneDynamicLogin,fetchSendSMS} from '../../../actions/mine/userAction';
//手机号登录界面
class PhoneLogin extends Component {
    ...
    login() {
        ...
        this.props.dispatch(fetchPhoneDynamicLogin(this.phone, this.verificationCode));
    }
    ...
    render() {
        return (
            <ImageBackground style={styles.background} source={require('../../../image/backgroundImage.jpg')}>
                <View onLayout={({nativeEvent: {layout: {x, y, width, height}}}) => {
                    this.headHeight = height
                }}>
                    <Head title={"手机登录"} click={()=>this.props.navigation.goBack()} head={{backgroundColor: 'rgba(0,0,0,0)'}}/>
                </View>
                <ScrollView
                    ref='scroll'
                ...
                <View style={{flex: 1}}/>
                <View style={{flexDirection: 'row', marginBottom: 10,backgroundColor:'rgba(254,200,46,0)'}}>
                    <View style={{flex: 1}}/>
...
const styles = StyleSheet.create({
    ...
    phone: {
        marginTop: constants.window.height * 0.1,
        flexDirection: 'row',
        padding: 20,
        paddingLeft: 22,
        paddingRight: 30,
